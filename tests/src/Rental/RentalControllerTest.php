...
use Sakila\Rental\{ RentalDto, RentalModel, RentalController };
...
class RentalControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->input = [
            "rental_id" => 5331,
            "rental_date" => "2021-09-29 11:14:33",
            "inventory_id" => 5380,
            "customer_id" => 3181,
            "return_date" => "2021-10-01 11:05:55",
            "staff_id" => 7526,
            "last_update" => "2021-09-26 19:07:20",
        ];
        $this->dto = new RentalDto($this->input);
        $this->model = new RentalModel($this->dto);
        $this->service = $this->createMock("Sakila\Rental\IRentalService");
